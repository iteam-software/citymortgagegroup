...
module.exports = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        trackingId: "G-LQ16S3GPNG",
        head: true, // This will add the tracking code to the site's <head> tag
        anonymize: true, // This is optional, but it anonymizes IP addresses for privacy.
      },
    },   
  ],
};
